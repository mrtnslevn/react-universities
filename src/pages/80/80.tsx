  ...
  return (
    <>
      <div className=" bg-gray-100 pt-5 ">
        <div className="flex justify-center pb-5">Total:{univ.length}</div>
        <div className="flex flex-row gap-5 pb-5 flex-wrap justify-center items-center">
